...
<div class="p-works mt-16">
    <div class="p-works__sticky">
        <div class="p-works__scroll">
            <div class="p-works__scroll--contents red">
                <h2 class="left">Hello</h2>
            </div>
            <div class="p-works__scroll--contents yellow"></div>
            <div class="p-works__scroll--contents green"></div>
            <div class="p-works__scroll--contents blue">
